...
type FingerPrintSetParam struct {
	...
	Strategy             *FlowStrategyAddParam `protobuf:"bytes,2,opt,name=strategy,proto3" json:"strategy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *FingerPrintSetParam) GetMacs() []string {
	if m != nil {
		return m.Macs
	}
	return nil
...
func (m *FingerPrintSetParam) GetStrategy() *FlowStrategyAddParam {
	if m != nil {
		return m.Strategy
	}
	return nil
...
var fileDescriptor_1bdf113f3d6e5a7a = []byte{
	...
	,
}
